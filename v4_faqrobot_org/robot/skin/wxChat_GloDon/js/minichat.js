    ...
    initBaseInfo: function (datajson) {
      ...
      */
      ...
      if(datajson){//如果有钉钉省份认证信息
        params.dd_userid=datajson.userid;//用户id;
        params.dd_name=datajson.name;//用户姓名;
        params.dd_isAdmin=datajson.isAdmin;
        params.dd_adpartment=datajson.department;
        params.dd_active=datajson.active;
      }
      //添加结束*******************************************************************************************
      return This.request({
        params: params,
