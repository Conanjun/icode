;$(function() {
    ...
    var FAQ = new Faqrobot({
        ...
        logoUrl: 'robot/skin/wxChat_GloDon/images/logo@2x.png',//logo地址 ----------
        logoId: 'logo',// ----------
         ...
         * 修改：添加服图标分为机器人和人工客服
         */
        kfPic: 'robot/skin/wxChat_GloDon/images/robot.png',  //客服图标
        kf_Robot_Pic: 'robot/skin/wxChat_GloDon/images/robot.png',  //机器人客服图标
        kf_Person_Pic: 'robot/skin/wxChat_GloDon/images/robot.png',  //人工客服图标
        kf_Robot_Name:'',//机器人客服名字，此处只是声明个变量，不用赋值
        kf_Person_Name:'',//人工客服名字

        khPic: 'robot/skin/wxChat_GloDon/images/user.png', //客户图标
