    ...
    ;(function($, window, document, undefined) {
        ...
        var plugName = "faqrobot",
            defaults = {
                ...
                kfHtml: [
                    ...
                    '<div class="MN_helpful"><span class="MN_reasonSend">提交</span><span class="MN_yes">有帮助</span><span class="MN_no">无帮助</span></div>',//是否满意组合
        ...
        Faqrobot.prototype = {
            ...
            advInfo:function(data){
            	var advid=$('#'+this.options.advId);//公告栏外部id
            	if(advid.length>0){
            		advInfoCallBack();
            	}
            	if(advid.length>0){
            		if(data.advList && data.advList.length>0){
	            		...
	            		$('#'+this.options.advId+' ul').html(advHtml);
	            	}else{
						$('#'+this.options.advId).hide();
					}
            	}
