				...
				if(typeof data.webConfig!="undefined"){
				  ...
				  if(typeof data.webConfig.logoUrl!="undefined"){
					  if(data.webConfig.logoUrl!==""){
						//$('.'+options.baseInfoDiv).css('background', '#fff url('+data.webConfig.logoUrl+') no-repeat center top');
				  ...
				  if(typeof data.webConfig.webName!="undefined"){
					  if(data.webConfig.webName!=""){
						cardhtml2+='<p class="contact1">'+data.webConfig.webName+'</p>';
					  }
				  } else {
					  cardhtml2+='<p class="contact1"> </p>';
				  }
				  if(typeof data.webConfig.webSite!="undefined"){
					  if(data.webConfig.webSite!=""){
						cardhtml2+='<a href="'+data.webConfig.webSite+'" target="_blank"><p class="contact2">'+data.webConfig.webSite+'</p></a>';
					  }
				  }
				  if(typeof data.webConfig.serviceTel!="undefined"){
					  if(data.webConfig.serviceTel!=""){
						cardhtml2+='<p class="contact4">'+data.webConfig.serviceTel+'</p>';
					  }
				  }
				  if(typeof data.webConfig.serviceQq!="undefined"){
					  if(data.webConfig.serviceQq!=""){
						cardhtml2+='<a href="http://wpa.qq.com/msgrd?v=3&uin='+data.webConfig.serviceQq+'&site=qq&menu=yes" target="_blank"><p class="contact2"><p class="contact5">QQ客服</p></a>';
					  }
				  }
				}
