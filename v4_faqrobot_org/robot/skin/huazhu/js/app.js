;$(function() {
    ...
    var FAQ = new Faqrobot({
        ...
        logoUrl: 'robot/skin/huazhu/images/logo@2x.png',//logo地址 ----------
        logoId: 'logo',// ----------
        webNameId: 'MN_logoWord',//公司名称Id
        //userInfoId: 'userInfoId',//用户信息Id
        kfPic: 'robot/skin/huazhu/images/robot.png',  //客服图标
        khPic: 'robot/skin/huazhu/images/user.png', //客户图标
        ...
        noView: ['.MN_kfImg', '.MN_khImg', '.FA_upFileNoImg'],
        faceModule: {//表情模块
            open: true,//是否启用功能
            faceObj: Face,//表情插件实例
        },
