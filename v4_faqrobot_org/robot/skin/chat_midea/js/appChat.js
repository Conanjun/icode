...
$('.userLoginOut').click(function(){
    $.ajax({
        ...
        success: function (data) {
            if (data.status === 0) {
                //  window.location.href = "http://oamuat.midea.com/sso-service/CleanupCookie?app=http://10.16.86.229:12580/robot/skin/midea/login.html";
                // 更新正式环境
                window.location.href = "http://idmws.midea.com/sso-service/CleanupCookie?app=http://5000ai.midea.com/robot/midea.html?sysNum=1476067342641247";
            }
        }
    })
})
...
$('#fileOne').on('change', '#fileupOne', function() {
   ...
   //展示附件的名称
    $('#hasUp').append('<p>' + fileName + '&nbsp;&nbsp;<span class="glyphicon glyphicon-remove delFile" aria-hidden="true" style="color: #f00;" param="fileOne"></span></p>');
    //判断当前已经上传了几个附件了
    if ($('#hasUp p').length > 2) {
        obj.addClass('hide');
    } else {
...
$('#fileTwo').on('change', '#fileupTwo', function() {
    ...
    var obj = $(this).parent().parent();
    $('#hasUp').append('<p>' + fileName + '&nbsp;&nbsp;<span class="glyphicon glyphicon-remove delFile" aria-hidden="true" style="color: #f00;" param="fileTwo"></span></p>');
    if ($('#hasUp p').length > 2) {
        obj.addClass('hide');
    } else {
        obj.addClass('hide').next().removeClass('hide');
...
$('#fileThree').on('change', '#fileupThree', function() {
    ...
    var obj = $(this).parent().parent();
    $('#hasUp').append('<p>' + fileName + '&nbsp;&nbsp;<span class="glyphicon glyphicon-remove delFile" aria-hidden="true" style="color: #f00;" param="fileThree"></span></p>');
    if ($('#hasUp p').length > 2) {
        obj.addClass('hide');
    } else {
        obj.addClass('hide').next().removeClass('hide');
            ...
            if (!data.status) {
                if (data.list && data.list.length > 0) {
                    ...
                    for (var i in data.list) {
                        ...
                        //创建状态
                        if (nowStatus == '创建') {
                            orderDetail.push('<div class="process-round roundPass-color"><div class="process-text"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></div><span class="process-time">创建<br>' + (data.list[i].create_time ? data.list[i].create_time : '') + '</span></div>');
                            orderDetail.push('<div class="crosswise"></div><div class="process-round"><div class="process-text"><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span></div><span class="process-time">分派</span></div>');
                            orderDetail.push('<div class="crosswise"></div><div class="process-round"><div class="process-text"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></div><span class="process-time">处理中</span></div>');
                            orderDetail.push('<div class="crosswise"></div><div class="process-round"><div class="process-text"><span class="glyphicon glyphicon-record" aria-hidden="true"></span></div><span class="process-time">关闭</span></div>');

                        } else if (nowStatus == '分派') {
                            orderDetail.push('<div class="process-round roundPass-color-ing"><div class="process-text"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></div><span class="process-time">新建<br>' + (data.list[i].create_time ? data.list[i].create_time : '') + '</span></div>');
                            orderDetail.push('<div class="crosswise roundPass-color"></div><div class="process-round roundPass-color"><div class="process-text"><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span></div><span class="process-time">分派</span></div>');
                            orderDetail.push('<div class="crosswise"></div><div class="process-round"><div class="process-text"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></div><span class="process-time">处理中</span></div>');
                            orderDetail.push('<div class="crosswise"></div><div class="process-round"><div class="process-text"><span class="glyphicon glyphicon-record" aria-hidden="true"></span></div><span class="process-time">关闭</span></div>');
                        } else if (nowStatus == '处理中') {
                            orderDetail.push('<div class="process-round roundPass-color-ing"><div class="process-text"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></div><span class="process-time">新建<br>' + (data.list[i].create_time ? data.list[i].create_time : '') + '</span></div>');
                            orderDetail.push('<div class="crosswise roundPass-color-ing"></div><div class="process-round roundPass-color-ing"><div class="process-text"><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span></div><span class="process-time">已分派<br>' + (data.list[i].acceptTime ? data.list[i].acceptTime : '') + '</span></div>');
                            orderDetail.push('<div class="crosswise roundPass-color"></div><div class="process-round roundPass-color"><div class="process-text"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></div><span class="process-time">处理中</span></div>');
                            orderDetail.push('<div class="crosswise"></div><div class="process-round"><div class="process-text"><span class="glyphicon glyphicon-record" aria-hidden="true"></span></div><span class="process-time">关闭</span></div>');
                        }else{
                            orderDetail.push('<div class="process-round roundPass-color-ing"><div class="process-text"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></div><span class="process-time">新建<br>' + (data.list[i].create_time ? data.list[i].create_time : '') + '</span></div>');
                            orderDetail.push('<div class="crosswise roundPass-color-ing"></div><div class="process-round roundPass-color-ing"><div class="process-text"><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span></div><span class="process-time">已分派<br>' + (data.list[i].acceptTime ? data.list[i].acceptTime : '') + '</span></div>');
                            orderDetail.push('<div class="crosswise processPass-color-ing"></div><div class="process-round roundPass-color-ing"><div class="process-text"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></div><span class="process-time">已处理<br>' + (data.list[i].close_time ? data.list[i].close_time : '') + '</span></div>');
                            orderDetail.push('<div class="crosswise processPass-color-ing"></div><div class="process-round roundPass-color-ing"><div class="process-text"><span class="glyphicon glyphicon-record" aria-hidden="true"></span></div><span class="process-time">关闭</span></div>');
                        }
...
// 显示催单modal
$('body').on('click', '.expediteOrderSpan', function(e) {
    $(this).siblings('.expediteModel').removeClass('hide');
    e.stopPropagation();
});

// 关闭催单modal
$('body').on('click', '.expedite-close', function() {
...
$('body').on('click', '.evaluateOrderFn', function() {
    if(danFlag){
        return;
    }
    danFlag=true;
