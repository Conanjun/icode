/**
 * taskId=1021 一汽定制页面 通过iframe嵌入官网 
 *  add by zhaoyuxing 
*/
;$(function() {
     //调用表情插件
    ...
    if(getUrlParam('lan') && getUrlParam('lan')=='en'){
        ...
        FAQ = new Faqrobot({
             ...
             * 修改：添加服图标分为机器人和人工客服
             */
            kfPic: 'robot/skin/miniChat_poc/robot.png',  //客服图标
            kf_Robot_Pic: 'robot/skin/miniChat_poc/robot.png',  //机器人客服图标
            kf_Person_Pic: 'robot/skin/miniChat_poc/robot.png',  //人工客服图标
            kf_Robot_Name:'',//机器人客服名字，此处只是声明个变量，不用赋值
            kf_Person_Name:'',//人工客服名字

            khPic: 'robot/skin/miniChat_poc/user_pic.png', //客户图标
    ...
    $('.input').autocomplete({
        url: 'servlet/AQ?s=ig',
            ...
            posAttr: ['-10px', '49px'],//外边框的定位[left bottom]
