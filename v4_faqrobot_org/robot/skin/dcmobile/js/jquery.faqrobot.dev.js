...
$.fn.extend({
	...
	function sayHello(data){
		...
		if(typeof data.webConfig.logoUrl!="undefined"){
			options.logoUrl=data.webConfig.logoUrl==''?"skin/dcmobile/images/logo.png":data.webConfig.logoUrl;
    ...
    function init_leadQuestions(data){
		...
		var robot_logo=$('<div/>').addClass('logoSize').html('<img class="img-circle" src='+options.logoUrl+'>').appendTo(allObj);
...
break;
    ...
    function createMyWordsHtml(msg,time){
		var myword='<div  class="client-msg" data-type="text"><div class="logoSize" style="right:0"><img class="img-circle" alt="" src="skin/dcmobile/images/ask.png"></div><div class="msg rightLogo"><div class="content">'+msg+'</div><span class="msg-status"></span> </div> </div>';
        return myword;
    }
	...
	function createRobotWordsHtmlItem(ansItem,time){
        ...
        robot_icon_small.html(replace_em(ansItem.ansCon));
        return allObj;
    }
    //下线的事件
    function offLine(){
