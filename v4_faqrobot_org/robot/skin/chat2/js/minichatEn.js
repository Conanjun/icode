    ...
    ;(function($, window, document, undefined) {
        ...
        var plugName = "faqrobot",
            defaults = {
                ...
                kfHtml: [
                    ...
                    '<div class="MN_helpful"><span class="MN_reasonSend">提交</span><span class="MN_yes">Satisfied</span><span class="MN_no">Dissatisfied</span></div>',//是否满意组合
                ...
                khHtml: '<div class="MN_ask"><div class="MN_khName">me</div><div class="MN_khCtn"><img class="MN_khImg" src="%khPic%"><i class="MN_khTriangle1 MN_triangle"></i><i class="MN_khTriangle2 MN_triangle"></i>%askWord%</div><div class="MN_khtime">%formatDate%</div></div>',//客户结构
        ...
        Faqrobot.prototype = {
        	    		...
        	    		if(data.status) {
        	    			...
        	    			if(data.list) {
        	    				if(data.list[0]) {
        	    					...
        	    					$('#'+ This.options.chatCtnId).prepend('<div class="MN_record" style="width:125px;">View more messages </div>');
            ...
            setLogo: function(data) {
        		...
        		if(this.options.titleChange) {// 是否修改标题
                    ...
                    if(question.indexOf('%我要发文件%')+1) {//发文件
                    	...
                    	if(This.robot.html) {// 当 This.robot.html 不为空时，走模拟答案
                    		...
                    		This.request({
                    		    ...
                    		    callback: function(data) {
                    		    	var robotHtml = This.robotHtml(data);
            ...
            timeRequest: function() {
				...
				This.mouseIsOn = true;
				var oldX = '';
                $(document).on('mousemove.FA', function(e) {
                	var newX = e.clientX;
                	if(oldX == newX) {
                	}else {// 移动了
	            		if(!This.mouseIsOn) {
