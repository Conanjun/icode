;$(function() {
    ...
    if(getUrlParam('lan') && getUrlParam('lan')=='en'){
        //英文模式
        FAQ = new Faqrobot({
            logoUrl: 'robot/skin/chat2_ecology2/images/logo_max.png',//logo地址 ----------
            logoId: 'logo',
             ...
             * 修改：添加服图标分为机器人和人工客服
             */
            kfPic: 'robot/skin/chat2_ecology2/images/robot.png',  //客服图标
            kf_Robot_Pic: 'robot/skin/chat2_ecology2/images/robot.png',  //机器人客服图标
            kf_Person_Pic: 'robot/skin/chat2_ecology2/images/robot.png',  //人工客服图标
            kf_Robot_Name:'',//机器人客服名字，此处只是声明个变量，不用赋值
            kf_Person_Name:'',//人工客服名字

            khPic: 'robot/skin/chat2_ecology2/images/serv.png', //客户图标
    ...
    */
    ...
    function set_body_height() {
        $('.body').height($('.whole').outerHeight() - $('.head').outerHeight()/2);
    }
    ...
    function set_bodyLeft_width() {
        $('.bodyLeft').width($('.body').outerWidth() - $('.bodyRight').outerWidth());
    }
