   ...
   var FAQ ='';
       FAQ = new Faqrobot({
           ...
           initCallback:function(data){
                ...
                this.kfHtml[1]='<div class="MN_helpful" style="margin-top: 8px;padding-top: 8px;"><span class="MN_reasonSend">提交</span><span style="color:#999; font-size:12px;">以上内容对您有帮助吗？</span><span class="MN_yes robot_review_yes"></i>有帮助</span><span class="MN_no"></i>无帮助</span></div>'
           }
       });
       FAQ.relateListStart=1;//智能推荐顺序从  1开始0
...
//    set_bodyLeft_width();
    ...
    *作用：1、设置显示热门的条数 2、前2条显示“hot”标注 2、第三条显示“new”
   */
