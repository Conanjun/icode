	...
	$("script").each(function(){
		...
		switch(webId){
			case "19203":   //猪八戒雇主
				...
				src="http://zbj.faqrobot.cn/robot/zbjEmployerDialog.html?sysNum="+sysNum+"&jid="+jId;
				break;
			case "19205":  //猪八戒服务商
				sysNum="149750805214520963";
				src="http://zbj.faqrobot.cn/robot/zbjProviderDialog.html?sysNum="+sysNum+"&jid="+jId;
				break;
		}
