addCssByLink('http://zbj.faqrobot.cn/robot/skin/zbj2/css/zbjServiceEmployer.css');
hasJquery();
...
window.onload=function(){
	...
	div.outerHTML='<div class="aw-wrapper retractFixed retract"><div id="dialog"><div id="prompt" class="hidden"><img src=""/></div><img src="http://zbj.faqrobot.cn/robot/skin/zbj2/images/allRetract.png" class="openImg"/><h3 class="aw-title aw-dragger hidden" style="opacity: 1; padding-top: 3px; display: block; height: 5px;font-size: 12px;">猜您想问：</h3>'
    	...
    	+'<div class="hoverlianxi hidden">联系客服</div></li></ul></div><div class="dialogIframe"><iframe src="http://zbj.faqrobot.cn/robot/zbjProviderDialog.html?sysNum=149750805214520963" id="dialogIframe" name="dialogIframe"></iframe></div></div>';
...
function closeIframe(){   //关闭iframe
	if(!$(".dialogIframe").hasClass("opacity")){
		...
		$(".openImg").attr("src","http://zbj.faqrobot.cn/robot/skin/zbj2/images/retractImg.png");
		}
	}
}

function BindEvent(){  //注册事件
	var url="/servlet/AQ?s=p&sysNum=149750805214520963";
	$.ajax({   //生成问题列表
		dtype:'post',
		datatype:'json',
		url: url,
			...
			for(var i in data.topAsk){
				...
				$(li).click(function(){
    				if($(".dialogIframe").hasClass("opacity")){
		    			...
		    			$(".openImg").attr("src","http://zbj.faqrobot.cn/robot/skin/zbj2/images/openImg.png");
		    		}
	...
	if($(".aw-wrapper").hasClass("openIframe")&&$(".aw-wrapper").hasClass("retract")){ //判断现在是否是缩小状态打开了iframe
			$(this).attr("src","http://zbj.faqrobot.cn/robot/skin/zbj2/images/openImg.png");
			...
			if($(".aw-wrapper").hasClass("retract")){  //是否只是在缩小的状态，并没有打开iframe
				$(this).attr("src","http://zbj.faqrobot.cn/robot/skin/zbj2/images/retractImg.png");
    			$(".aw-content").removeClass("hidden");
    			$(".aw-title").removeClass("hidden");
    			$(this).css("top","-77px");
    			$(this).css("left","17px");
			...
			$(this).attr("src","http://zbj.faqrobot.cn/robot/skin/zbj2/images/allRetract.png");
	...
	$(".aw-default-tool-item").each(function(){
		$(this).click(function(){
			if($(".dialogIframe").hasClass("opacity")){
				...
				$(".aw-content").removeClass("hidden");
    			$(".aw-title").removeClass("hidden");
    			$(".openImg").css("top","-77px");
    			$(".openImg").css("left","17px");
    			$(".span").removeClass("hidden");
    			$("#dialog").css("width","120");
    			$(".aw-wrapper").removeClass("retractFixed").addClass("openFixed");
    			$(".dialogIframe").css("top","-135px");
	...
	$(".openImg").hover(function(){   //提示语hover事件
		if($(".aw-wrapper").hasClass("retract")){
			...
			$("#prompt").children("img").attr("src","http://zbj.faqrobot.cn/robot/skin/zbj2/images/zbjclick-open.png");
			$("#prompt").css("right","25px");
		}else if(!$(".aw-wrapper").hasClass("retract")){
			$("#prompt").removeClass("hidden");
			$("#prompt").children("img").attr("src","http://zbj.faqrobot.cn/robot/skin/zbj2/images/zbjclick-retract.png");
			$("#prompt").css("right","90px");
		}
	},function(){
		$("#prompt").addClass("hidden");
	});
