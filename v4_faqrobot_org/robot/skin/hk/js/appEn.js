...
;$(function() {
    ...
    var FAQ = new Faqrobot({
        ...
        logoUrl: 'robot/skin/hk/images/logo@2x.png',//logo地址 ----------
        logoId: 'logo',// ----------
        ...
        kfPic: 'robot/skin/hk/images/robot.png',  //客服图标
        khPic: 'robot/skin/hk/images/user.png', //客户图标
	...
	//a标签点击在APP中不能用target=blank
	$('body').on('click', 'a', function(e) {
	    var tmpHref=$(this).attr('href');
        if($(this).attr('target')=='_blank'){
		   if($(this).hasClass('wflink') || $(this).hasClass('welcomeWords')){}else{
				e.preventDefault();
