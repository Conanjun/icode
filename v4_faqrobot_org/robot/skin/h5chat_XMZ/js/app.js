;$(function() {
    ...
    $('body').on('click',function(e){
        ...
        if($(e.target).is('#sendFace') || $(e.target).is('.faceBtn') || e.target.innerHTML == '表情'){
            $('.editCtn_com span').removeClass('sendPicClick sendVoiceClick sendCameraClick sendFaceClick sendFileClick commonQueClick feedbackClick leaveMsgClick downloadCenterClick');
    ...
    $('.editCtn_com').click(function (e) {
          if(!$(this).is('.sendFaceCtn')){
            e.stopPropagation();
            $(this).siblings('.editCtn_com').children('span,p').removeClass('btnClass sendPicClick sendVoiceClick sendCameraClick sendFaceClick sendFileClick commonQueClick feedbackClick leaveMsgClick downloadCenterClick');
    ...
    var FAQ = new Faqrobot({
        ...
        logoUrl: 'robot/skin/h5chat_XMZ/images/logo@2x.png',//logo地址 ----------
        logoId: 'logo',// ----------
         ...
         * 修改：添加服图标分为机器人和人工客服
         */
        kfPic: 'robot/skin/h5chat_XMZ/images/robot.png',  //客服图标
        kf_Robot_Pic: 'robot/skin/h5chat_XMZ/images/robot.png',  //机器人客服图标
        kf_Person_Pic: 'robot/skin/h5chat_XMZ/images/robot.png',  //人工客服图标
        kf_Robot_Name:'',//机器人客服名字，此处只是声明个变量，不用赋值
        kf_Person_Name:'',//人工客服名字

        khPic: 'robot/skin/h5chat_XMZ/images/user.png', //客户图标
