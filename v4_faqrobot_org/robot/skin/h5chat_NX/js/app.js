;$(function() {
    ...
    function set_chatScroll_height() {
        ...
        $('.chatScroll').height(winH-$('.editCtn').outerHeight() - 80);
    }
    ...
    var FAQ = new Faqrobot({
        ...
        setInputTop:false,//键盘遮挡问题
        isNongXin:true,//判断留言
        logoUrl: 'robot/skin/h5chat_NX/images/logo@2x.png',//logo地址 ----------
        logoId: 'logo',// ----------
         ...
         * 修改：添加服图标分为机器人和人工客服
         */
        kfPic: 'robot/skin/h5chat_NX/images/robot.png',  //客服图标
        kf_Robot_Pic: 'robot/skin/h5chat_NX/images/robot.png',  //机器人客服图标
        kf_Person_Pic: 'robot/skin/h5chat_NX/images/robot.png',  //人工客服图标
        kf_Robot_Name:'',//机器人客服名字，此处只是声明个变量，不用赋值
        kf_Person_Name:'',//人工客服名字

        khPic: 'robot/skin/h5chat_NX/images/user.png', //客户图标
