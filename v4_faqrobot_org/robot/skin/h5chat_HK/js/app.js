;$(function() {
    ...
    var FAQ = new Faqrobot({
        ...
        setInputTop:true,
        logoUrl: 'robot/skin/h5chat_HK/images/logo@2x.png',//logo地址 ----------
        logoId: 'logo',// ----------
         ...
         * 修改：添加服图标分为机器人和人工客服
         */
        kfPic: 'robot/skin/h5chat_HK/images/robot.png',  //客服图标
        kf_Robot_Pic: 'robot/skin/h5chat_HK/images/robot.png',  //机器人客服图标
        kf_Person_Pic: 'robot/skin/h5chat_HK/images/robot.png',  //人工客服图标
        kf_Robot_Name:'',//机器人客服名字，此处只是声明个变量，不用赋值
        kf_Person_Name:'',//人工客服名字

        khPic: 'robot/skin/h5chat_HK/images/user.png', //客户图标
        ...
        sendCallback: function() {//点击发送按钮的回调
            ...
            var word = ['人工', '不要机器人', '没解决', '未解决', '315', '工商局', '电视台', '政府', '消费者协会'];
            word.forEach(function(key) {
                if(question.indexOf(key)+1) {
                    try {
                        XIAONENE && XIAONENE.openSDK();
                    }catch(e) {
