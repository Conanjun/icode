...
"<table>";"undefined"!=typeof a.webConfig.serviceQq&&(d+='<tr><td>Q\u00a0Q\uff1a</td><td><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin='+a.webConfig.serviceQq+'&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:'+a.webConfig.serviceQq+':51" alt="QQ\u5728\u7ebf\u5ba2\u670d" title="QQ\u5728\u7ebf\u5ba2\u670d"/></a></td></tr>');if("undefined"!=typeof a.advs)for(a=a.advs,i=0;i<a.length;i++){var e=b.trim(a[i].name),f=b.trim(a[i].value),k=a[i].type;0==k?d+="<tr><td>"+e+"\uff1a</td><td>"+
f+"</td></tr>":1==k?d+="<tr><td>"+e+"\uff1a</td><td>"+f+"</td></tr>":2==k?d+="<tr><td>"+e+"\uff1a</td><td>"+f+"</td></tr>":3==k&&(d+="<tr><td>"+e+'\uff1a</td><td><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin='+f+'&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:'+f+':51" alt="'+e+'" title="'+e+'"/></a></td></tr>')}d+="</table>";b("#"+c.advInfoDiv).html(d)}}function P(a,d){a&&2<a.length&&d&&0<d.length&&b("#"+a).html(d)}function C(a,d,e,f,k){if(!d)return"";a=b("<dl/>").appendTo(b("#"+
a));e=D(d.length);for(f=0;f<e;f++)if(d[f]){k=b("<dt/>");var g=c.formatBaseQueCount&&c.formatBaseQueCount(d[f],f+1,e,c.queConMaxWordsCount)||E(d[f].question);!1!==g&&(b("<a/>").html(g).appendTo(k).attr("href","javascript:void(0)").attr("title",d[f].question).attr("aid",d[f].solutionId).click(function(){$this=b(this);u($this.attr("title"),$this.attr("aid"));return!1}),k.appendTo(a))}}function E(a,d){return d?a.length>d?a.substring(0,d)+"...":a:a}function D(a){return c.maxTopQuestions&&c.maxTopQuestions<
a?c.maxTopQuestions:a}function x(){var a=new Date,d=a.getFullYear(),b=a.getMonth()+1,c=a.getDate(),k=a.getHours(),g=a.getMinutes(),a=a.getSeconds();return d+"-"+b+"-"+c+" "+k+":"+g+":"+a}function q(a,d){z.fadeIn(800);z.find("span").html(a);z.delay(1E3).fadeTo("slow",.2).fadeTo("slow",1).fadeOut(800,function(){"function"==typeof d&&d()})}function F(){var a="",a=m.val(),a=a.replace(/[\r\n]/g,"");""!=a&&a!=c.inputMagOldvalue&&(m.val(""),b(".ac_results").hide(),1==a.length&&0<a&&"undefined"!=typeof t[a-
1]&&(a=t[a-1],t=[]),u(a),b("#"+c.wordremain).html(100),m.focus())}function u(a,d){if(a&&0<a.length){var b=c.basePath+"AQ?s=aq";d&&0<d++&&(b+="&sId="+d+"&sysNum="+c.sysNum);A(a);w(b,n,0,c.dataType,{question:a})}}function A(a){if(a||0!=a.length){var d;(d=c.showMyWords&&c.showMyWords(a,x()))||(x(),d='<div  class="client-msg" data-type="text"><div class="logoSize" style="right:0"><img class="img-circle" alt="" src="'+c.khUrl+'"></div><div class="msg rightLogo"><div class="content">'+a+'</div><span class="msg-status"></span> </div> </div>');
l.append(d);l.scrollTop(l[0].scrollHeight)}}function n(a){if(a||0!=a.length){var d;if(!(d=c.showRobotWords&&c.showRobotWords(a,x())))if(d=x(),"undefined"==typeof a.robotAnswer||0==a.robotAnswer.length)d="";else{for(var b,f,k=0;k<a.robotAnswer.length;k++)f=a.robotAnswer[k],f=Q(f,d),b?b.after(f):b=f;d=b}l.append(d);l.scrollTop(l[0].scrollHeight)}}function Q(a,d){var e="",f="";"undefined"!=typeof a.gusWords&&null!=a.gusWords?(e=""==a.gusWords.ydWords?"\u60a8\u662f\u4e0d\u662f\u8981\u54a8\u8be2\u4e0b\u9762\u7684\u95ee\u9898\uff1f":
a.gusWords.ydWords,f=""==a.gusWords.afterWords?"":a.gusWords.afterWords):(e="\u60a8\u662f\u4e0d\u662f\u8981\u54a8\u8be2\u4e0b\u9762\u7684\u95ee\u9898\uff1f",f="");if(!a)return"";var k=b("<div/>").addClass("staff-msg");b("<div/>").addClass("name").appendTo(k).html(c.robotName);b("<div/>").addClass("logoSize").html('<img class="img-circle" src='+c.kfUrl+">").appendTo(k);var g=b("<div/>").addClass("msg logoMsg").appendTo(k),l=b("<div/>").addClass("content").appendTo(g),h=b("<div/>").addClass("content").appendTo(g),
m=b("<div/>").addClass("content").appendTo(g);b("<span/>").addClass("msg-status").appendTo(g);g=b("<div/>").addClass("content").appendTo(g);if("undefined"!=typeof a.aId&&0!=a.aId){var p=a.aId;g.addClass("helper_aid_"+p).addClass("helper");b("<a/>").addClass("robot_review_yes").attr("helptag",1).attr("aid",p).click(G).html('<span class="robot_help_yes"></span>').appendTo(g);b("<a/>").addClass("robot_review_no").attr("helptag",0).attr("aid",p).click(G).html('<span class="robot_help_no"></span>').appendTo(g)}if("undefined"!=
typeof a.aId&&0!=a.aId&&c.sugQuestionDiv&&2<c.sugQuestionDiv.length&&"undefined"!=typeof a.relateLessList&&1<a.relateLessList.length){g=a.relateLessList;if(!g)return"";for(var n=b("<span/>").addClass("question").html("\u4f60\u662f\u5426\u8fd8\u60f3\u95ee\u5982\u4e0b\u95ee\u9898\uff1a").appendTo(h),n=b("<ol/>").appendTo(h),r=D(g.length),h=0;h<r;h++)if(g[h]){var q=c.formatBaseQueCount&&c.formatBaseQueCount(g[h],h+1,r,c.queConMaxWordsCount)||E(g[h].question);if(!1!==q){var p=b("<li/>").appendTo(n).html(h+
1+".\u00a0"),v=b("<a/>");v.html(q).appendTo(p).attr("href","javascript:void(0)").attr("title",g[h].question).attr("aid",g[h].solutionId).click(function(){$this=b(this);u($this.attr("title"),$this.attr("aid"));return!1});t[h]=g[h].question}}}""!=a.ansCon&&0<a.ansCon.length&&l.html(a.ansCon);if(0<a.relateList.length){n=b("<dl/>").append("<dt>"+e+"</dt>").appendTo(m);g=a.relateList;e=b("<ol/>").appendTo(m);for(h=0;h<g.length;h++)l=b.trim(g[h].question),p=g[h].solutionId,p=b("<li/>").appendTo(e),v=b("<a/>"),
v.html(l).appendTo(p).attr("href","javascript:void(0)").attr("title",l).attr("aid",g[h].solutionId).click(function(){$this=b(this);u($this.attr("title"),$this.attr("aid"));return!1}),t[h]=l;b("<dt/>").html(f).appendTo(n);return k}if(0<a.gusList.length){n=b("<span/>").addClass("question").html(e).appendTo(m);e=b("<ol/>").appendTo(m);g=a.gusList;for(h=0;h<g.length;h++)l=b.trim(g[h].seedQuestion.question),p=g[h].solutionId,p=b("<li/>").appendTo(e),v=b("<a/>"),v.html(l).appendTo(p).attr("href","javascript:void(0)").attr("title",
l).attr("aid",g[h].solutionId).click(function(){$this=b(this);u($this.attr("title"),$this.attr("aid"));return!1}),t[h]=l;b("<span/>").addClass("question").html(f).appendTo(m);return k}if(""==a.ansCon)return l.html("\u00a0"),k;l.html(a.ansCon);return k}function H(){var a=c.basePath+"AQ?s=offline&nocache="+(new Date).getTime();b.getJSON(a,function(a){0==a.status&&(a=eval('({"robotAnswer":{"ansCon":"\u60a8\u5df2\u4e0b\u7ebf\uff0c\u611f\u8c22\u60a8\u7684\u4f7f\u7528\uff01\u5982\u679c\u9700\u8981\u518d\u6b21\u804a\u5929\uff0c\u8bf7\u91cd\u65b0\u6253\u5f00\u6216\u5237\u65b0\u672c\u9875\u9762\uff01","status":0,"tspan":2}})'),
...
b.ajax({type:"get",datatype:"json",cache:!1,url:encodeURI(d),data:a.serialize(),success:function(d){b(".fadeBackModal").fadeOut(800);b(".fadeBackContent").fadeOut(800);a[0].reset();q(d.message)}})}var t=[],l=b("#"+c.chatContDiv);l.parent();var m=b(r),z=b("#"+c.showErrorId),I=window.location.href.split("?"),J=[],J=-1!==I[1].indexOf("jid=")?I[1].split("&"):[""];m.focus(function(){b(this).val()==b(this).attr("oldvalue")&&b(this).val("");b(this).css("color","#333");b(this).parent().addClass("robot_inputon")}).blur(function(){""==
