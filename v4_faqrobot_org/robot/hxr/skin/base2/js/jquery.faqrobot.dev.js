  ...
  function createMyWordsHtml(msg,time){
   ...
   //字数统计
    ...
    function helpclick(){
            ...
            var s_q_url='';
            if(usefull==1){
                s_q_url=options.basePath+'AQ?s=addufc&aId='+aid+'&sysNum='+options.sysNum+'&cluid='+uid;
            }else{
                s_q_url=options.basePath+'AQ?s=addulc&aId='+aid+'&sysNum='+options.sysNum+'&cluid='+uid;
            }
            request(s_q_url);
        }
    //****************************************公用方法******************************************//
