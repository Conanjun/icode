    ...
    ;(function($, window, document, undefined) {
        ...
        var plugName = "faqrobot",
            defaults = {
            	    ...
            	    noCallback: function($obj) {//不满意的回调
            	    	if(window.uselessReasonItems) {
            	    	    if(window.uselessReasonItems[0]) {
								...
								$obj.before('<form class="MN_reasonForm"><div class="MN_reasonCtn"><p class="MN_reasonTitle">非常抱歉没能解决您的问题，您可以点击编辑框右侧的“+”，新增帮助，您也可以查询我的帮助哟。</p></div></form>');
            	    	    }else {
            	    	        $obj.text('感谢您的评价！');
            	    	    }
            	    	}else {
        		...
        		noView: ['.MN_kfImg', '.MN_khImg', '.FA_upFileNoImg','.i-img'],//图片放大预览 all/全不能预览 或者 指定不能预览的class['.MN_kfImg', '.MN_khImg', '.FA_upFileNoImg']
            ...
            askQue: function() {
                ...
                if(question) {//问题不为空
                    ...
                    if(question.indexOf('%我要发文件%')+1) {//发文件
                    	...
                    	This.$obj.$chatCtnId.append(This.customHtml(This.replaceFace(filterXSS(This.$obj.$inputCtnId.val()))));//添加我的话
