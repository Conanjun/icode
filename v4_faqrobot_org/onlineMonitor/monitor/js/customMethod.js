...
$.fn.adcCreator = function(cb, bb) {
	...
	var self = this;
	var $delBD = $('<div class="modal" id="ADCDELModal" aria-hidden="false"><div class="modal-backdrop fade in" style="height: 5000px" id="ADCBackDrop"></div><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h4 class="modal-title">确认删除？</h4></div><div class="modal-body"><p>确定要删除您所选的内容？</p></div><div class="modal-footer"><a href="javascript:;" class="btn btn-sm btn-primary" id="adc-ok-ensure">确认</a> <a href="javascript:;" class="btn btn-sm btn-white" id="adc-cancel-ensure">取消</a></div></div></div></div>');
	$delBD.hide().appendTo($('body')).fadeIn('300');
