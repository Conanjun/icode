			...
			var setting = {
				...
				callback: {
					onClick: function (e, treeId, treeNode) {
						_this.groupId = treeNode.Id;
						_this.listEnd = false;
						_this.listIndex = 0;
						_this.pageNo = 1;
						console.log('onClick before empty this.list: '+_this.list);
						$(_this.list).children('li:not(.clearFloat)').remove();
						console.log('onClick after empty this.list: '+_this.list);
						console.log('onClick: '+_this.listEnd);
						_this.getImageData();
						$('#queSel').html(treeNode.Name);
						$("#menuContent").fadeOut("fast");
					}
				}
			};
				...
				ajax.request(url, {
					...
					'onsuccess': function (r) {
						try {
							...
							if (json.state == 'SUCCESS') {
								console.log('getImageData success this.list: '+_this.list);
							...
							if (r.responseText.indexOf('ue_separate_ue') != -1) {
								...
								console.log('getImageData error this.list: '+_this.list);
								_this.pushData(list);
